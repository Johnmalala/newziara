            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              {isLoading ? (
                  ...
                  {bookings.map((booking) => (
                    <div key={booking.id} className="flex flex-col md:flex-row items-center border rounded-lg p-4 hover:bg-gray-50 transition-colors">
                      ...
                      <div className="flex-grow">
                        <Link to={`/listing/${booking.listing_id}`} className="font-bold text-lg text-gray-800 hover:text-red-600">{booking.listing?.title}</Link>
                      ...
                      <div className="text-right mt-4 md:mt-0">
                        <p className="font-bold text-lg text-red-600">${booking.total_amount}</p>
                ...
                <div className="text-center py-10">
                  ...
                  <Link to="/tours" className="bg-red-600 text-white px-6 py-2 rounded-lg hover:bg-red-700">Explore Tours</Link>
                </div>
              )}
            </div>
          </div>
