  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        ...
        <button onClick={() => openModal()} className="bg-primary text-white px-4 py-2 rounded-lg flex items-center hover:brightness-90 w-full sm:w-auto justify-center">
          ...
          <table className="w-full text-sm text-left text-gray-500">
            <thead className="text-xs text-gray-700 uppercase bg-gray-50">
              <tr>
                ...
                <th scope="col" className="px-6 py-3 hidden md:table-cell">Contact Person</th>
            ...
            <tbody>
              {partners.map((partner) => (
                <tr key={partner.id} className="bg-white border-b hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 hidden md:table-cell">{partner.contact_person}</td>
                  <td className="px-6 py-4 hidden lg:table-cell">{partner.email}</td>
