        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/tours" className="text-gray-300 hover:text-red-400 transition-colors">Tours</a></li>
              <li><a href="/stays" className="text-gray-300 hover:text-red-400 transition-colors">Stays</a></li>
              <li><a href="/volunteers" className="text-gray-300 hover:text-red-400 transition-colors">Volunteer</a></li>
              <li><a href="/custom-package" className="text-gray-300 hover:text-red-400 transition-colors">Custom Package</a></li>
            </ul>
          </div>
